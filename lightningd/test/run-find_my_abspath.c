...
/* Generated stub for gossip_gather_filters */
void gossip_gather_filters(struct lightningd *ld UNNEEDED,
			   u8 ***receive_scriptpubkeys UNNEEDED,
			   struct bitcoin_outpoint **spend_utxos UNNEEDED)
{ fprintf(stderr, "gossip_gather_filters called!\n"); abort(); }
...
/* Generated stub for txfilter_gather_filters */
void txfilter_gather_filters(const struct txfilter *filter UNNEEDED,
			     u8 ***receive_scriptpubkeys UNNEEDED,
			     struct bitcoin_outpoint **spend_utxos UNNEEDED)
{ fprintf(stderr, "txfilter_gather_filters called!\n"); abort(); }
...
/* Generated stub for wallet_gather_filters */
void wallet_gather_filters(struct wallet *w UNNEEDED,
			   u8 ***receive_scriptpubkeys UNNEEDED,
			   struct bitcoin_outpoint **spend_utxos UNNEEDED)
{ fprintf(stderr, "wallet_gather_filters called!\n"); abort(); }
...
/* Generated stub for watch_gather_filters */
void watch_gather_filters(struct chain_topology *topo UNNEEDED,
			  u8 ***receive_scriptpubkeys UNNEEDED,
			  struct bitcoin_outpoint **spend_utxos UNNEEDED)
{ fprintf(stderr, "watch_gather_filters called!\n"); abort(); }
